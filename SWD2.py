...
country_of_origin = choose_option("Select the country of origin:", ["Japan", "Germany", "USA", "South Korea", "Sweden", "UK"])
min_year = int(input("Enter the minimum year of manufacture (from 2020): "))
max_year = int(input("Enter the maximum year of manufacture (to 2023): "))
min_hp = int(input("Enter the minimum horsepower (from 98): "))
max_hp = int(input("Enter the maximum horsepower (to 1200): "))
body_type = choose_option("Select your preferred body type:", ["Sedan", "Coupe", "SUV", "Crossover", "Hatchback"])
min_price = float(input("Enter the minimum price (from 15000 USD): "))
max_price = float(input("Enter the maximum price (to 120000 USD): "))
min_trunk_volume = float(input("Enter the minimum trunk volume (from 250 to 1200 L): "))
min_wheel_size = float(input("Enter the minimum wheel size (from 14 to 22 inches): "))
